<template>
  <PageWrapper with-padding>
    <ArticlePage title="Terms and Conditions">
      ...
      <p>
        This website is operated and run by {{ legalName }}. Throughout the
        site, the terms "we", "us" and "our" refer to {{ legalName }}.
        {{ legalName }} offers this website, including all information, tools
      ...
      <p>
        ...
        conditions ("Terms and Conditions of Service", "Terms"), including those
        additional terms and conditions and policies referenced herein and/or
        available by hyperlink. These Terms and Conditions of Service apply to
      ...
      <p>
        ...
        site, you agree to be bound by these Terms and Conditions of Service. If
        ...
        Conditions of Service are considered an offer, acceptance is expressly
        limited to these Terms and Conditions of Service.
      </p>
      <p>
        Any new features or tools which are added to the current store shall
        also be subject to the Terms and Conditions of Service. You can review
        the most current version of the Terms and Conditions of Service at any
        time on this page. We reserve the right to update, change or replace any
        part of these Terms and Conditions of Service by posting updates and/or
      ...
      <p>
        By agreeing to these Terms and Conditions of Service, you represent that
      ...
      <p>
        ...
        threatening, libelous, defamatory, pornographic, obscene, is a medical
        claim, or otherwise objectionable or violates any party's intellectual
        property or these Terms and Conditions of Service.
      </p>
      <p>
      ...
      <p>
        ...
        Conditions of Service, you are prohibited from using the site or its
      ...
      <p>
        In no case shall Aspen Valley Group LLC, our directors, officers,
        employees, affiliates, agents, contrfunctions, interns, suppliers,
        service providers or licensors be liable for any injury, loss, claim, or
      ...
      <p>
        You agree to indemnify, defend and hold harmless Aspen Valley Group LLC
        and our parent, subsidiaries, affiliates, partners, officers, directors,
        agents, contrfunctions, licensors, service providers, subcontrfunctions,
        ...
        arising out of your breach of these Terms and Conditions of Service or
      ...
      <p>
        In the event that any provision of these Terms and Conditions of Service
        ...
        severed from these Terms and Conditions of Service, such determination
      ...
      <p>
        These Terms and Conditions of Service are effective unless and until
        terminated by either you or us. You may terminate these Terms and
        Conditions of Service at any time by notifying us that you no longer
      ...
      <p>
        ...
        comply with any term or provision of these Terms and Conditions of
      ...
      <p>
        ...
        Terms and Conditions of Service shall not constitute a waiver of such
        right or provision.
      </p>
      <p>
        These Terms and Conditions of Service and any policies or operating
      ...
      <p>
        Any ambiguities in the interpretation of these Terms and Conditions of
        Service shall not be construed against the drafting party.
      </p>
      <h2>Governing Law</h2>

      <p>
        These Terms and Conditions of Service and any separate agreements
        whereby we provide you Services shall be governed by and construed in
        accordance with the laws of Denver, CO.
      </p>
      ...
      <p>
        ...
        replace any part of these Terms and Conditions of Service by posting
        ...
        Terms and Conditions of Service constitutes acceptance of those changes.
      </p>
      <h2>Contact Information</h2>

      <p>
        Questions about the Terms and Conditions of Service can be addressed by
        emailing us at
        <a
          target="_blank"
          rel="noopener noreferrer"
          :href="
            `mailto:${supportEmail}?subject=Questions%20about%20your%20terms%20and%20conditions&body=Hello!%0A%0AI%20have%20a%20few%20questions%20about%20the%20terms%20and%20conditions%20on%20your%20website...`
          "
          >{{ supportEmail }}</a
        >.
      </p>
