    ...
    <ArticlePage title="Return Policy">
      ...
      <p>
        ...
        <a
          ...
          :href="
            `mailto:${supportEmail}?subject=I%20believe%20I%20may%20be%20eligible%20for%20a%20return&body=Hello!%20I%20believe%20my%20item%20may%20have%20been%20lost%20in%20shipping%2C%20and%20I%20understand%20that%20I%20may%20not%20be%20eligible%20for%20a%20return%20in%20any%20other%20case.%0A%0AMy%20order%20number%20is%20(fill%20in%20your%20order%20number%20here).%0A%0AThank%20you`
          "
          >{{ supportEmail }}</a
        >.
      </p>
      <p>
        Generally, {{ legalName }} does not offer returns or refunds. If your
        item has been lost in shipping or you have not received the item yet, we
        may be willing to offer you a return, provided that sufficient evidence
        shows that the item has indeed been lost in transit.
      </p>
      ...
      <p>
        After you've contacted us with the necessary proof of purchase and
        evidence, and if we believe you are eligible for a refund, we will
        notify you. We will also notify you of the approval or rejection of your
        refund.
      </p>
      <p>
      ...
      <p>
        ...
        refund is officially posted (up to 30 days).
      </p>
      <p>
